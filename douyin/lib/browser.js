...
// 初始化浏览器
async function initBrowser(headless = true, viewport = null, profileInput = null) {
  ...
  try {
    ...
    logger.step('启动浏览器', { headless, viewport: defaultViewport, profile: profileName, userDataDir });
